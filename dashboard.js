...
function renderKPIs(k) {
  ...
  const cards = [
    ...
    { label:'% Oportunidad ANS',  value:k.pctOport+'%',   color:'green', icon:'🎯',
      sub:`${k.cumpleOport} cumplen · ${k.noCumpleOport} no cumplen (de ${k.entregados} entregados)`,
      pct:k.pctOport,
      rows: k.entregadosRows.filter(r=>getCol(r,'CUMPLE ANS','cumple ans').toUpperCase()==='NO') },
